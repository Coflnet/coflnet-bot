...
func (s *Server) decodeAPIChatInternalClientPostRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request APIChatInternalClientPostReqApplicationJSON
		if err := func() error {
...
func (s *Server) decodeAPIChatMuteDeleteRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request APIChatMuteDeleteReqApplicationJSON
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeAPIChatMutePostRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request APIChatMutePostReqApplicationJSON
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeAPIChatSendPostRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request APIChatSendPostReqApplicationJSON
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
