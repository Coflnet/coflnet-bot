...
// ProductsServiceServiceSlugOwnedGet implements GET /Products/service/{serviceSlug}/owned operation.
//
// List of periods some user owned a service.
//
// GET /Products/service/{serviceSlug}/owned
func (UnimplementedHandler) ProductsServiceServiceSlugOwnedGet(ctx context.Context, params ProductsServiceServiceSlugOwnedGetParams) (r []OwnershipTimeFrame, _ error) {
	return r, ht.ErrNotImplemented
}
