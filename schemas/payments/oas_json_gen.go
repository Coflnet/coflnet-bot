...
// Encode implements json.Marshaler.
func (s *OwnershipTimeFrame) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *OwnershipTimeFrame) encodeFields(e *jx.Encoder) {
	{
		if s.UserId.Set {
			e.FieldStart("userId")
			s.UserId.Encode(e)
...
var jsonFieldsNameOfOwnershipTimeFrame = [3]string{
	0: "userId",
	1: "start",
	2: "end",
}

// Decode decodes OwnershipTimeFrame from json.
func (s *OwnershipTimeFrame) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode OwnershipTimeFrame to nil")
	}
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode OwnershipTimeFrame")
	}
...
// MarshalJSON implements stdjson.Marshaler.
func (s *OwnershipTimeFrame) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *OwnershipTimeFrame) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
var jsonFieldsNameOfTopUpOptions = [7]string{
	0: "successUrl",
	1: "cancelUrl",
	2: "userEmail",
	3: "topUpAmount",
...
func (s *TopUpOptions) Decode(d *jx.Decoder) error {
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "userIp":
			if err := func() error {
				s.UserIp.Reset()
				if err := s.UserIp.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"userIp\"")
			}
		case "locale":
			if err := func() error {
				s.Locale.Reset()
