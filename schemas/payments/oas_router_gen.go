					...
					case 's': // Prefix: "service"
						...
						case '/': // Prefix: "/"
							...
							case '/': // Prefix: "/"
								...
								case 'o': // Prefix: "owned"
									if l := len("owned"); len(elem) >= l && elem[0:l] == "owned" {
										elem = elem[l:]
									} else {
										break
									}
							...
							case '/': // Prefix: "/"
								...
								case 'o': // Prefix: "owned"
									...
									if len(elem) == 0 {
										switch method {
										case "GET":
											// Leaf: ProductsServiceServiceSlugOwnedGet
											r.name = "ProductsServiceServiceSlugOwnedGet"
											r.operationID = ""
											r.pathPattern = "/Products/service/{serviceSlug}/owned"
											r.args = args
											r.count = 1
											return r, true
										default:
