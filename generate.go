...
//go:generate go run github.com/ogen-go/ogen/cmd/ogen --ct-alias text/json=application/json --package chat --target ./schemas/chat --clean ./schemas/chat/swagger.yml
